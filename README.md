...
O sistema permite que usuários listem, atribuam notas e escrevam comentários sobre jogos, criando um histórico pessoal com experiências de seus jogos favoritos.
